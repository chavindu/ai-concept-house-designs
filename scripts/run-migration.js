...
// Simple migration runner that uses fetch to connect to your database
// This approach works if your Azure PostgreSQL has REST API enabled
...
console.log('   docker run --rm -e PGPASSWORD=YOUR_PASSWORD -v ${PWD}/scripts:/scripts postgres:17 psql -h ai-builder-db-server.postgres.database.azure.com -U postgres -d postgres -f /scripts/azure-migration.sql');
console.log('');
console.log('2. AZURE CLOUD SHELL:');
console.log('   - Go to https://shell.azure.com');
console.log('   - Upload your migration script');
console.log('   - Run: psql -h ai-builder-db-server.postgres.database.azure.com -U postgres -d postgres -f azure-migration.sql');
console.log('');
console.log('3. WEB-BASED CLIENT:');
console.log('   - Use pgAdmin, DBeaver, or Adminer');
console.log('   - Connect to your Azure PostgreSQL database');
console.log('   - Copy and paste the SQL content');
console.log('');
console.log('4. VS CODE EXTENSION:');
console.log('   - Install "PostgreSQL" extension');
console.log('   - Connect to your database');
console.log('   - Run the script directly');
